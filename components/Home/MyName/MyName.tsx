...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        Hi,<span className="waving-hand">👋</span> my name is
      </motion.span>
      <motion.h1
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ...
      >
        I&apos;m a <span className="text-AAsecondary">Computer Science B.Tech undergraduate</span>, i possess strong problem-solving skills and
        specialize in crafting exceptional <br className="2xl:block hidden" />
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">Full Stack Applications</span>,
        ...
        <span className="text-AAsecondary">MERN Stack</span> and{" "}
        <span className="text-AAsecondary">NextJS</span>. 
